# <center>ETL BASICS AND DATA TRANSFORMATION USING TALEND</center>
...
3.	Follow the detailed instructions given below to obtain access to Data technology learning platform 
   (https://developer.cisco.com/site/dlp/ )

4.  Basic knowledge of Apache hadoop and Big Data.

5.  Basic knowledge of ETL (Extract, Transform, Load).  

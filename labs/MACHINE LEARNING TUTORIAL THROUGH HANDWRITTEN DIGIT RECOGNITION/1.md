...
After launching the DTLP dashboard page, navigate to learning labs tab. Select the learning lab "Machine Learning tutorial through Handwritten Digit Recognition" and click on "Start" button as shown in screenshot below:
...
On enabling the pop-up, Zeppelin would open in a new window taking you to Zeppelin home page with pre-configured notebook - "Cisco DevNet DTLP Machine Learning" as shown in screenshot below.
...
* Select pre-created notebook - "Cisco DevNet DTLP Machine Learning" from home page and below mentioned screen would be shown to the you:
...
### <b>Step 6 : Prepare for Modeling</b>
...
### <b>Step 7 : Look at Example Image</b>
...
### <b>Step 8 : Look at Random Example Image</b>
...
### <b>Step 9 : Split Training and Validation Data</b>

...
After launching the DTLP dashboard page, navigate to learning labs tab. Select the learning lab "Network data transformation and visualization using Tableau" and click on "Start" button as shown in screenshot below:

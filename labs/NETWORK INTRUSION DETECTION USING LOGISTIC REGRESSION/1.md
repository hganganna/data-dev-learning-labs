...
4. To get a basic understanding to build a network intrusion detector using different Machine Learning algorithms such as        Logistic Regression, SVM, Naive Bayes.

...
After launching the DTLP dashboard page, navigate to learning labs tab. Select the learning lab "Network Data Ingestion" and click on "Start" button as shown in screenshot below:

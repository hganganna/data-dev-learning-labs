...
<b>Programming Language Used</b> : Java, XML

<b>Executed on</b> : Hadoop Big Data Platform

<b>Visualization tool Used</b> : Canvas logview

## OVERVIEW

This learning lab can be used as a guide to get a high level understanding for using CSA(Connected Streaming Analytics) in  DTLP(Data Technology Learning Platform) platform. DTLP platform has Kafka messaging framework that works from the backend. 

![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA11.jpeg?raw=true)
...
### <b>Step 1 : Select Learning Lab and Start</b>
...
![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA2.jpeg?raw=true)

### <b>Step 2 : Workspace Page</b>

On click of Start button, user will be navigated to a workspace page where all the components - IDE, Tools and Microservices required to execute the program are available. Please refer the screenshot below:

![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA1.jpeg?raw=true)

### <b>Step 3 : Tasks in Workspace</b>

Points to Note:
The order for starting the services is as shown below:

![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA.jpeg?raw=true)

* Start all the tasks except logview in the specific sequence as mentioned in the flow diagram above. 

![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA4.jpeg?raw=true)
...
![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA3.jpeg?raw=true)
...
![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA5.jpeg?raw=true)

### <b>Step 4 : Stop, Build and Run the Program</b>
...
![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA6.jpeg?raw=true)
...
![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA7.jpeg?raw=true)
...
![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA8.jpeg?raw=true)

### <b>Step 5 : Start Logview service from DLP</b>

* Start the logview service. Please refer screenshot below:

![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA10.jpeg?raw=true)

* Launch logview and visualize the output. 

logview will open in a seperate tab and the output would be as shown below:

![alt-tag](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/WORD COUNT USING SCALA WITH APACHE SPARK/assets/images/CSA9.jpeg?raw=true)

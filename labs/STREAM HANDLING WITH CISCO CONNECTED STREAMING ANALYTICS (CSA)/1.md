...
After launching the DTLP dashboard page, navigate to learning labs tab. Select the learning lab "Stream handling with Cisco Connected Streaming Analytics(CSA)" and click on "Start" button as shown in screenshot below:

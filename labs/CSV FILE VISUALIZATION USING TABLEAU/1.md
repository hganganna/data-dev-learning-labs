...
From Learning Labs pane, select the learning lab "CSV File Visualization using Tableau" and click on "Start" button as shown in screenshot below:
...
* Start the Tableau(service in visualize column) and the colour of the icon should be Green for launch button to be enabled. Please refer screenshot below:
...
Once started, it will look as shown below:
